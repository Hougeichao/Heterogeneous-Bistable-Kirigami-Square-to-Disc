...
%% convexity conditions for slits in the first stable state
...
%% convexity conditions for panels
g(17) = -dot(W*s1,u1) + epsilon;
g(18) = -dot(W*u1,v1) + epsilon;
g(19) = -dot(W*v1,t1) + epsilon;
g(20) = -dot(W*t1,s1) + epsilon;
g(21) = -dot(s2,W*u2) + epsilon;
g(22) = -dot(u2,W*v2) + epsilon;
g(23) = -dot(v2,W*t2) + epsilon;
g(24) = -dot(t2,W*s2) + epsilon;
g(25) = -dot(W*s3,u3) + epsilon;
g(26) = -dot(W*u3,v3) + epsilon;
g(27) = -dot(W*v3,t3) + epsilon;
g(28) = -dot(W*t3,s3) + epsilon;
g(29) = -dot(s4,W*u4) + epsilon;
g(30) = -dot(u4,W*v4) + epsilon;
g(31) = -dot(v4,W*t4) + epsilon;
g(32) = -dot(t4,W*s4) + epsilon;

%% convexity conditions for slits in the second stable state
...
g(49) = -((det(R1 - R2))^2) + epsilon_2;
g(50) = -((det(R2 - R3))^2) + epsilon_2;
g(51) = -((det(R3 - R4))^2) + epsilon_2;
g(52) = -((det(R4 - R1))^2) + epsilon_2;
h = [];
